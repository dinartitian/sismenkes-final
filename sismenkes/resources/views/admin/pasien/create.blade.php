...
@section('title', 'Tambah Data Pasien') <!-- Menetapkan judul halaman menjadi "Tambah Data Pasien" -->
    ...
    <div class="container-fluid">
        <div class="app-content-header mt-3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Tambah Data Pasien</h3> <!-- Judul halaman -->
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="col-md-11">
                <div class="card shadow-lg border-light">
                    <div class="card-header bg-success text-white rounded-top">
                        <h4 class="mb-0">Tambah Data Pasien</h4> <!-- Judul form -->
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('alamat') is-invalid @enderror border border-primary" id="alamat" name="alamat"
                                            rows="4" required placeholder="Masukkan Alamat Pasien">{{ old('alamat') }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
